    ...
    return (
        ...
        <div className="sticky flex flex-col w-3/12 py-5 pl-6 pr-8 bg-white rounded-md shadow top-4 sm:flex-row sm:items-center sm:pr-6">
            ...
            <div className="absolute sm:relative sm:top-auto sm:right-auto ml-auto right-4 top-4 text-gray-400 hover:text-gray-800 cursor-pointer">
                <svg onClick={handleCLose} className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg>
            </div>
        </div>
    )
}
